    ...
    <div className="bg-white rounded-xl shadow-sm">
        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead>
            <tr className="text-left">
              ...
              <th className="px-4 md:px-6 py-4 text-sm font-medium text-gray-500">Email</th>
              <th className="hidden md:table-cell px-6 py-4 text-sm font-medium text-gray-500">Phone</th>
              <th className="hidden lg:table-cell px-6 py-4 text-sm font-medium text-gray-500">Role</th>
          ...
          <tbody className="divide-y divide-gray-200">
            {users.map((user) => (
              <tr key={user.id} className="hover:bg-gray-50">
                ...
                <td className="px-4 md:px-6 py-4 text-gray-500">{user.email}</td>
                <td className="hidden md:table-cell px-6 py-4 text-gray-500">{user.phone}</td>
      ...
      <div className="p-4 md:p-6 border-t border-gray-200">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-gray-500">Showing 1 to 10 of 126 entries</p>
          <div className="flex gap-2">
